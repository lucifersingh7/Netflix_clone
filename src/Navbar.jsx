...
function Navbar()
{
    return(
        ...
        <ul>
            ...
            <li><a href="/signup" style={ {backgroundColor:"red", borderRadius:"10px",padding:"7px 20px"}}>Sign up</a></li>
        </ul>
        </div>
